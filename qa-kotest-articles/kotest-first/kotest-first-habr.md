...
Непрерывно нахожусь в поиске идеального набора инструментов для организации автоматизации тестирования в больших командах, который обеспечит:
...
Это инструмент для создания / конфигурирования / запуска / контроля выполнения тестов - `Junit` для **Kotlin**.  
...
Обзоров по автоматизации тестирования на **Kotlin**, и про **Kotest** в частности — немного. 
