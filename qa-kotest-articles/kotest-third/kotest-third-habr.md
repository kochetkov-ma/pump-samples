...
> Сразу отвечаю на вопрос: `Что быдет если несколько таких расширений?`  
...
[картинка про синхронное выполнение по цепочке]()
...
[картинка про адаптеры для разных фреймворков]()
